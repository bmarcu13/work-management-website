          ...
          <hr></hr>
            <div className="first-container">
                <div className="who-we-are-text">
                    ...
                    <h4>WORK MANAGEMENT este abilitata, conform certificatelor de abilitare nr.1312/PS din 24.02.2021 emis de Ministerul Muncii, Familiei si Protectiei Sociale – ITM Bucuresti, sa desfasoare activitatii specifice de prevenire si protectie.
                        <br/><br/>
                        Something<br/><br/>
                        <p>(NOTICE:)</p>
