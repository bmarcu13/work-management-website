          ...
          <hr></hr>
            <div className="first-container">
                <div className="who-we-are-text">
                    ...
                    <p>WORK MANAGEMENT este abilitata, conform certificatelor de abilitare nr.1312/PS din 24.02.2021 emis de Ministerul Muncii, Familiei si Protectiei Sociale – ITM Bucuresti, sa desfasoare activitatii specifice de prevenire si protectie.
                        <br/><br/>
                        Something<br/><br/>
                        <p>(NOTICE:)</p>
                ...
                <div className="second-container">
                    <div className="iso-images">
                        <div className="first-row-certificates">
                        ...
                        <div className="second-row-certificates">
                            <img className="iso-img" src={Iso_blue} alt="iso_blue" style={{width:'150px', height:'150px'}}></img>
                            <img className="iso-img"  src={Iso_orange} alt="iso_orange" style={{width:'150px', height:'150px'}}></img>
                        </div>
                    </div>
                    <div className="our-mission-text">
                        ...
                        <p>Lucratorii bine motivati si bine instruiti, lucrand cu echipamente si materiale eficiente si bine intretinute, pot obtine o calitate mai buna, o
productivitate mai buna si performante economice mai bune.</p>
