...
export const servicesInfo = [
    {
        ...
        information:
            '#style{"fontWeight":"bold", "fontSize": 22}Serviciile noastre SSM includ#/:\n\n' +
    ...
    },
    {
        ...
        information:
            '#style{"fontWeight":"bold", "fontSize": 22}SITUAȚII DE URGENȚĂ (Prevenirea și Stingerea incendiilor / Protecție civilă)#/\n\n' +
            '#style{"fontWeight":"bold"}Work Management#/ oferă în domeniul Situațiilor de Urgență (PSI) consultanţă de specialitate în conformitate cu normele metodologice de aplicare a prevederilor din Legea Nr. 307/2006.\n\n' +
    ...
    },
    {
        ...
        information:
            "Conform Legii 211/2011, toți deținătorii/producătorii de deșeuri persoane juridice, comercianții, precum și operatorii economici autorizați pentru colectare/transport deșeuri au OBLIGAȚIA să " +
    ...
    },
    {
        ...
        information:
            '#style{"fontWeight":"bold","fontSize":21}WORK MANAGEMENT #/ organizează cursuri de perfecționare în conformitate cu cerințele ' +
    ...
    },
    {
        ...
        information:
            '#style{"fontWeight":"bold", "fontSize": 21}Oferim:#/\n\n' +
    ...
    },
    {
        ...
        highlights: [
            ...
            },
            {
                ...
                text: "Portal destinat testării angajaților tăi, iar separat, unul pentru responsabilul SSM/ manager.",
            },
        ],
        information:
            '#style{"fontWeight":"bold","fontSize":22, "textDecoration":"underline"}APLICAȚIE PC/IOS/ANDROID SSM, SU ȘI RSVTI#/\n\n' +
        ...
        information2:
            "Toate documentele pot fi vizualizate, descărcate și modificate în funcție de cerințele beneficiarului sau de obligațiile legale.\n" +
            ...
            '\n\n#style{"fontWeight":"bold", "color":"red"}Testele pot fi modificate#/ în orice moment, în funcție de instructajele parcurse de angajați sau privind noi riscuri apărute#style{"fontWeight":"bold","color":"red"}!#/(de exemplu: riscul de infectare cu SARS-CoV-2.) \n\n' +
    ...
    },
    {
        ...
        highlights: [
            {
                ...
                name: "Suport",
                text: "Implemenatarea certificărilor ISO ",
            },
            {
                icon: <RiOrganizationChart size={40}></RiOrganizationChart>,
                name: "Plan de măsuri",
        ...
        information:
            '#style{"fontWeight":"bold", "fontSize":21, "marginLeft": "25px", "color":"rgb(6, 6, 114)"}AUDIT#/\n\n' +
        ...
        information2:
            '#style{"fontWeight":"bold","fontSize":21, "marginLeft": "25px", "color":"rgb(6, 6, 114)"}EVALUAREA RISCURILOR#/\n\n' +
    ...
    },
    {
        ...
        information:
            '#style{"fontWeight":"bold", "marginTop":"-200px"}Producem și comercializăm#/ întreaga gamă de indicatoare de securitate, care sunt prevăzute de normele legale în vigoare.\n' +
    ...
    },
    {
        ...
        information:
            '#style{"fontWeight":"bold", "fontSize": 22}Asigurarea serviciilor de personal#/\n\n' +
        ...
        information2:
            '#style{"fontWeight":"bold", "fontSize": 22}Asistenţă la controalele Instituţiilor de drept#/\n\n' +
